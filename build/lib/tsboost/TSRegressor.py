            ...
            for i, horizon in enumerate(horizons):
                if type(horizon) == int:
                    if horizon > 0:
                        ...
                        raise Exception('horizons in list must be positives')
                else:
                    raise Exception('horizons in list must be integers')
        else:
            raise Exception('horizon must be a list of integers')
        return horizons
